...
{
    public class DriverCurrentViewModel : PageModel
    {
        private readonly ILogger<DriverCurrentViewModel> _logger;
        [BindProperty]
        ...
        public DriverCurrentViewModel(ILogger<DriverCurrentViewModel> logger, DB db)
        {
            _logger = logger;
            this.db = db;
        }
